...
<div class="container-fluid my-3">
	...
	<div class="row">
		...
		<div class="shadow-lg mb-5 bg-white rounded" style="box-shadow: 0 1rem 3rem rgba(0,0,0,.175)!important; padding: 1rem 2rem; width: 250%; margin-left: -70%; box-sizing: border-box;">
				<br/>
				<div id="main" style="height: 450px;overflow-y: scroll;overflow-x: hidden;">
					<div id="loading">	
						<img src="../images/dots.gif" class="img-responsive" width="10%"/>
					</div>
					<div id="chat" style="display:none;">			
						...
						<div class="col-md-1 text-right pr-0 mt-auto">
							...
							&nbsp;&nbsp;<div class="col-md-8" style="background-color: #80808047;padding: 10px;border-radius: 20px 20px 20px 0px;">
								<span>Hi, Welcome to our CCAcademy Chatbot! How can I help you? Type "Command" to search something</span>
							</div>
							<div class="col-md-3">
							</div>
						</div>
						...
						if($count > 0)
						{
							while($row = mysqli_fetch_array($data))
							{
								...
								if($row["answer"] != "")
								{
									echo '<div class="row">
											<div class="col-md-1 text-right pr-0 mt-auto">
												<i class="class="fas fa-chalkboard-user" style="background-color: #004d00; ;padding: 5px;color: white;border-radius: 16px;"></i>
											</div>
											&nbsp;&nbsp;
											<div class="col-md-8" style="background-color: #80808047;padding: 10px;border-radius: 20px 20px 20px 0px;">
												<span>'.nl2br($row["answer"]).'</span>
...
$(document).on('submit', '#send', function(event){
	...
	$.ajax({
		...
		success:function(data)
		{
			...
			{ 		
				$("#chat").append('<div class="row temp_loading"><div class="col-md-1 text-right pr-0 mt-auto"><i class="class="fas fa-chalkboard-user" style="background-color: #004d00; padding: 5px;color: white;border-radius: 16px;"></i></div>&nbsp;&nbsp;<div class="col-md-8" style="background-color: #80808047;padding: 10px;border-radius: 20px 20px 20px 0px;"><span><img src="../images/dots.gif" class="img-responsive" width="10%"/></span></div><div class="col-md-3"></div></div><br/>');
